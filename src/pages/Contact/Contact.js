          ...
          <div className="contact-details">
            ...
            <div className="svgs">
              ...
              <svg
                ...
                viewBox="0 0 24 24"
                onClick={() =>
                  window.open("https://github.com/nickawwas", "_blank")
                }
              >
              ...
              <svg
                ...
                onClick={() =>
                  window.open(
                    "https://github.com/nickawwas/Algo-Learn",
                    "_blank"
                  )
                }
              >
              ...
              <svg
                ...
                viewBox="0 0 24 24"
                onClick={() =>
                  window.open("mailto: nicholas.b.kawwas@gmail.com")
                }
              >
              ...
              <svg
                ...
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/nicholaskawwas/",
                    "_blank"
                  )
                }
              >
      ...
      <div className="msg-container">
        <div className="msg-section">
          ...
          <div className="msg-experience">
            I hope you enjoyed the website experience I built.
          </div>

          <div className="msg-cta">
            If you are in need of an aesthetic and functional website, feel free
            to contact me.
          </div>
          <div className="msg-cta">
            If you enjoyed my work, consider supporting me to help fund the
            future of Algo Learn.
          </div>
          ...
          <div className="msg-thanks">
            ...
            <button
              className="donate"
              onClick={() =>
                window.open("https://paypal.me/oddmemegod/", "_blank")
              }
            >
              <svg
                xmlns={svgUrl}
