...
export const edgeCases = ["UB (A)", "UR (B)", "UL (D)", "LU (E)", "LF (F)", "LD (G)", "LB (H)", "FR (J)", "FD (K)", "FL (L)", "RU (M)", "RB (N)", "RD (O)",
"RF (P)","BU (Q)", "BL (R)", "BD (S)", "BR (T)", "DF (U)", "DR (V)", "DB (W)", "DL (X)"]


export const edgeAlgos = [algsUB, algsUR, algsUL, algsLU, algsLF, algsLD, algsLB, algsFR, algsFD, algsFL, algsRU, algsRB, algsRD, algsRF, algsBU, algsBL, algsBD, algsBR, algsDF, algsDR, algsDB, algsDL]