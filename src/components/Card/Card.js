            ...
            <div className="algs" key={`${algo.case} ${key}`}>
              <div className="alg-case">
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  className={
                    !spin.includes(algo) ? "rotateCube" : "rotateCube spin"
                  }
                  onClick={() => updateSpin(algo)}
                >
                ...
                <img
                  src={fetchImg(
                    algo?.url || baseUrl,
                    setCubeRotation(algo) + algo.algs[0].alg
                  )}
                  alt="Cube"
                />
              </div>
              ...
              <div className="alg-notation">
                {algo.algs.map(({ alg }) => (
                  <span className="alg-moves" key={alg}>
                    {alg}
                  </span>
                ))}
              </div>
